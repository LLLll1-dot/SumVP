...
- [Apache Hadoop](https://hadoop.apache.org/releases.html) 2.6+
- [Apache Spark](https://spark.apache.org/downloads.html) 2.4+
...
- **DESCRIPTION:** QueryExecutor module submits the Spark SQL query generated by the SPARQLTranslator module to spark for execution. QueryExecutor allows you to submit spark SQL queries translated from multiple SPARQL queries at the same time, and no need to reload data. You can get the query results in the resultTime.txt file in the current directory. QueryExecutor is a maven project. You need to install Maven to compile this project. Of course, you can also compile the project in your own way.
